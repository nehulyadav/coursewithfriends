...
if (typeof someObject == 'undefined') $.loadScript('https://www.gstatic.com/firebasejs/4.8.1/firebase.js', function(){
  ...
  s1.setAttribute( 'src', 'https://www.gstatic.com/firebasejs/4.8.1/firebase-app.js');
  document.body.appendChild( s1);

    var s2 = document.createElement( 'script' );
  s2.setAttribute( 'src', 'https://www.gstatic.com/firebasejs/4.8.1/firebase-auth.js');
  document.body.appendChild( s2 );

    var s3 = document.createElement( 'script' );
  s3.setAttribute( 'src', 'https://www.gstatic.com/firebasejs/4.8.1/firebase-database.js');
  document.body.appendChild( s3 );

    var s4 = document.createElement( 'script' );
  s4.setAttribute( 'src', 'https://www.gstatic.com/firebasejs/4.8.1/firebase-firestore.js');
  document.body.appendChild( s4 );

    var s5 = document.createElement( 'script' );
  s5.setAttribute( 'src', 'https://www.gstatic.com/firebasejs/4.8.1/firebase-messaging.js' );
